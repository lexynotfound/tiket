...
<body>
  ...
  border-radius: 10px;" class="card">
                    <div style="border: 3px;
  padding: 25px;
  border-radius: 10px;" class="card-title blue white-text">
                        <p>Yohanna Ticket</p>
                    </div>
                    <div class="card-content">
                        <div class="row">
                            <div class="col s6">
                                ...
                                $sr = mysqli_query($conn, 'select * from reservasi where id_reserv="' . $id_reserv . '" ');
  ...
  border-radius: 10px;" class="card-title blue white-text">
                    ...
                    <div class="card-content">
                        <?php
                        include "koneksi.php";
                        $sc = mysqli_query($conn, 'select * from pelanggan where username="' . $_SESSION['user'] . '" ');
                        $qc = mysqli_fetch_array($sc);
                        $scus = mysqli_query($conn, 'select * from pelanggan where id_customer="' . $qc['id_customer'] . '" ');

...
<body>
  ...
  border-radius: 10px;" class="card-panel white-text blue">
                    <h5>Rute</h5>
                    <table>
                        <thead style="background-color: rgba(0, 0, 0, 0.25); border: 3px;
  padding: 25px;
  border-radius: 10px;" class="white-text">
                            <tr>
                                <td>Depart At</td>
                                <td>Rute From</td>
                                <td>Rute To</td>
                        ...
                        <tbody class="white-text">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="rute_d.php?id_rute=<?= $dtt['id_rute']; ?>" onclick="return confirm('Sure, want to delete?');"><button style="border: 3px;
  padding: 10px;
  border-radius: 10px;" class="red btn waves-effect"><i class="ion-trash-b"></i></button></a>
                                        <a href="rute_u.php?id_rute=<?= $dtt['id_rute']; ?>"><button style="border: 3px;
  padding: 10px;

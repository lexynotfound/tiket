...
<body>
  ...
  border-radius: 10px;" class="card-panel white-text blue">
            ...
            <div class="col s8">
                <div style="border: 3px;
  padding: 25px;
  border-radius: 10px;" class="card-panel white-text red">
            ...
            <div class="col s8">
                <div style="border: 3px;
  padding: 25px;
  border-radius: 10px;" class="card-panel white-text green">
                    <h5>Rute</h5>
                    <a href="rute.php" target="_blank" class="white-text">Open in New Tab</a>
                </div>
            </div>
            <div class="col s4">
                <div class="card-panel white-text" style="background-color: #F39C12;border: 3px;
  padding: 25px;
  border-radius: 10px;">
                    <h5>Reservation</h5>

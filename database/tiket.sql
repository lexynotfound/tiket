...
INSERT INTO `pelanggan` (`id_customer`, `name`, `address`, `phone`, `gender`, `username`) VALUES
...
INSERT INTO `reservasi` (`id_reserv`, `reserv_code`, `reserv_at`, `reserv_date`, `seat`, `depart`, `price`, `id_user`, `id_customer`, `id_rute`, `status`) VALUES
...
INSERT INTO `transportasi` (`id_trans`, `code`, `description`, `seat`, `id_trans_type`) VALUES
...
INSERT INTO `tipe_transportasi` (`id_trans_type`, `description`) VALUES
(1, 'Pesawat'),
(2, 'Kereta');
...
--
ALTER TABLE `rute`
  ADD CONSTRAINT `rute_ibfk_1` FOREIGN KEY (`id_trans`) REFERENCES `transportasi` (`id_trans`);

--
-- Ketidakleluasaan untuk tabel `trans`
--
ALTER TABLE `transportasi`
  ADD CONSTRAINT `trans_ibfk_1` FOREIGN KEY (`id_trans_type`) REFERENCES `tipe_transportasi` (`id_trans_type`);
